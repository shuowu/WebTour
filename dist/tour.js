...
/**
 * @fileoverview Templates in namespace Tour.templates.
 * @public
 */

if (typeof Tour == 'undefined') { var Tour = {}; }
if (typeof Tour.templates == 'undefined') { Tour.templates = {}; }


Tour.templates.overlay = function(opt_data, opt_ignored) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml('<div class="tour-overlay"></div>');
};
if (goog.DEBUG) {
  Tour.templates.overlay.soyTemplateName = 'Tour.templates.overlay';
}


Tour.templates.captionBar = function(opt_data, opt_ignored) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml('<div class="tour-caption-bar">' + soy.$$escapeHtml(opt_data.caption) + '</div>');
};
if (goog.DEBUG) {
  Tour.templates.captionBar.soyTemplateName = 'Tour.templates.captionBar';
}
;(function(window, $) {
  var app = {};
